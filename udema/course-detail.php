	...
	<script type="text/javascript">
      var onloadCallback = function() {
        grecaptcha.render('html_element', {
          'sitekey' : '6LdMGfoZAAAAAE4CPeu9mJ5rmosUgsi3DFftAXk0'
        });
      };
    </script>
...
<body>
	...
	<header class="header menu_2">
		...
		<ul id="top_menu">
			...
			<li><a href="course-detail.html#0" class="search-overlay-menu-btn">Search</a></li>
			<li class="hidden_tablet"><a href="admission.html" class="btn_1 rounded">Admission</a></li>
		</ul>
		<!-- /top_menu -->
		<a href="course-detail.html#menu" class="btn_mobile">
		...
		<nav id="menu" class="main-menu">
			<ul>
				<li><span><a href="course-detail.html#0">Home</a></span>
					<ul>
				...
				<li><span><a href="course-detail.html#0">Courses</a></span>
					<ul>
				...
				<li><span><a href="course-detail.html#0">Pages</a></span>
					<ul>
				...
				<li><span><a href="course-detail.html#0">Extra Pages</a></span>
					<ul>
	...
	<main>
		...
		<div class="bg_color_1">
			<nav class="secondary_nav sticky_horizontal">
				<div class="container">
					<ul class="clearfix">
						<li><a href="course-detail.html#description" class="active">Description</a></li>
						<li><a href="course-detail.html#lessons">Lessons</a></li>
						<li><a href="course-detail.html#reviews">Reviews</a></li>
					</ul>
				</div>
			</nav>
				...
				<div class="row">
							...
							<div id="accordion_lessons" role="tablist" class="add_bottom_45">
								<div class="card">
									<div class="card-header" role="tab" id="headingOne">
										<h5 class="mb-0">
											<a data-bs-toggle="collapse" href="course-detail.html#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="indicator ti-minus"></i> Introdocution</a>
										</h5>
									</div>
										...
										<div class="card-body">
											<div class="list_lessons">
												<ul>
													...
													<li><a href="course-detail.html#0" class="txt_doc">Audiology</a><span>00:59</span></li>
												</ul>
											</div>
										</div>
									</div>
								...
								<div class="card">
									<div class="card-header" role="tab" id="headingTwo">
										<h5 class="mb-0">
											<a class="collapsed" data-bs-toggle="collapse" href="course-detail.html#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
								...
								<div class="card">
									<div class="card-header" role="tab" id="headingThree">
										<h5 class="mb-0">
											<a class="collapsed" data-bs-toggle="collapse" href="course-detail.html#collapseThree" aria-expanded="false" aria-controls="collapseThree">
								...
								<div class="card">
									<div class="card-header" role="tab" id="headingFourth">
										<h5 class="mb-0">
											<a class="collapsed" data-bs-toggle="collapse" href="course-detail.html#collapseFourth" aria-expanded="false" aria-controls="collapseFourth">
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail">
							...
							<a  onclick="openForm()" class="btn_1 full-width">Purchase</a>

							<a href="course-detail.html#0" class="btn_1 full-width outline"><i class="icon_heart"></i> Add to wishlist</a>
							<div id="list_feat">
	...
	if (isset($_POST['submit'])) {
		...
		if(isset($_POST['g-recaptcha-response']))
		{
			...
			if(!$recaptcha){
				echo "<script>alert('Please go back and check recaptcha')</script>"; 
				header("Location: course-detail.php");
			}
			else{
			$secretkey = "6LdMGfoZAAAAAE4CPeu9mJ5rmosUgsi3DFftAXk0";
			$url = "https://www.google.com/recaptcha/api/siteverify?
			secret= '.$secretkey.' &response='.$recaptcha.'&remoteip= $UserIP";
			$response = file_get_contents ($url);
			$responsekey = json_decode($response,true);
	
	
			$sql = "SELECT * FROM registration WHERE fname ='$fname'";
			
			$result = mysqli_query($conn, $sql);
			
				$sql = "INSERT INTO `registration` (`fname`, `email`, `pnum`)
				 VALUES ('$fname', '$email', '$pnum');";
	...
	<!-- ********************************************************************************** -->
							<div class="form-popup" id="myForm">
							  <form  class="form-container" action="" method="POST">
								  ...
								  <h2  class="black">Register here</h2>
			...
			<div class="row justify-content-between">
				<div class="col-lg-5 col-md-12">
					...
					<div class="follow_us">
						<ul>
							<li>Follow us</li>
							<li><a href="course-detail.php#0"><i class="ti-facebook"></i></a></li>
							<li><a href="course-detail.php#0"><i class="ti-twitter-alt"></i></a></li>
							<li><a href="course-detail.php#0"><i class="ti-google"></i></a></li>
							<li><a href="course-detail.php#0"><i class="ti-pinterest"></i></a></li>
							<li><a href="course-detail.php#0"><i class="ti-instagram"></i></a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 ml-lg-auto">
					<h5>Useful links</h5>
					<ul class="links">
						<li><a href="course-detail.php#0">Admission</a></li>
						<li><a href="course-detail.php#0">About</a></li>
						<li><a href="course-detail.php#0">Login</a></li>
						<li><a href="course-detail.php#0">Register</a></li>
						<li><a href="course-detail.php#0">News &amp; Events</a></li>
						<li><a href="course-detail.php#0">Contacts</a></li>
					</ul>
				</div>
				<div class="col-lg-3 col-md-6">
					...
					<form method="post" action="assets/newsletter.htm" name="newsletter_form" id="newsletter_form">
			...
			<div class="row">
				<div class="col-md-8">
					<ul id="additional_links">
						<li><a href="course-detail.php#0">Terms and conditions</a></li>
						<li><a href="course-detail.php#0">Privacy</a></li>
					</ul>
				</div>
				<div class="col-md-4">
